...
public class InitDateUtil {
    public static void main(String[] args) {
        ...
        bookList.add(new Book(1, "java入门", "张三", Constant.TYPE_COMPUTER, "123-1", "中华出版社", Constant.STATUS_STORAGE));
        bookList.add(new Book(2, "java进阶", "李四", Constant.TYPE_COMPUTER, "123-1", "中华出版社", Constant.STATUS_STORAGE));
        ...
        Book book=new Book(1, "java入门", "张三", Constant.TYPE_COMPUTER, "123-1", "中华出版社", Constant.STATUS_STORAGE);
        Lend lend = new Lend();
        //使用UUID来生成编号
